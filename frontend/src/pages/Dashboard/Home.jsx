...
import { addThousandsSaperators } from '../../utils/helper'
      ...
      <div className='my-5 mx-auto'>
        <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
          <Infocard
            icon={<IoMdCard />}
            label="Total Balance"
            value={addThousandsSaperators(dashboardData?.totalBalance || 0)}
            color="bg-violet-500"
          />
          <Infocard
            icon={<LuWalletMinimal />}
            label="Total Income"
            value={addThousandsSaperators(dashboardData?.totalIncome || 0)}
            color="bg-orange-500"
          />
          <Infocard
            icon={<LuHandCoins />}
            label="Total Expense"
            value={addThousandsSaperators(dashboardData?.totalExpenses || 0)}
            color="bg-red-500"
          />
        </div>
